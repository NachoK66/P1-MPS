...
public class EvolutionaryAlgorithm {
    ...
    public int[][] optimize(int[][] population) throws EvolutionaryAlgorithmException {
        ...
        if (population != null && population.length  > 0 ) {
            ...
            for (int i = 0; i < population.length - 1; i += 2) {    // El incremento de 2 daba error en matrices impares, se ha añadido el -1 para evitarlo. 
                                                                    // No es la única opción, esta no modifca el último elemento en impares
