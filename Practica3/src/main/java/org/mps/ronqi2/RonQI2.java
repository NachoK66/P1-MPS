/* Corregido por Ignacio Morillas Rosell, Grupo ZI */
...
public abstract class RonQI2 {
    ...
    */
    public boolean inicializar(){
        ...
        if (disp == null) {     // Corregido
            System.out.println("Asigne un dispositivo antes de inicializar.");
        } else if (disp.conectarSensorPresion()){
    ...
    */
    public boolean reconectar(){
        boolean result = false;
        if (disp == null) {     // Corregido
            System.out.println("Asigne un dispositivo antes de reconectar.");
        } else if (!estaConectado()){       // Corregido
    ...
    */
    public boolean estaConectado(){
        return disp != null && disp.estaConectado();    // Corregido
    }    
}
