...
public class RonQI2Silver extends RonQI2{
    ...
    */
    public void obtenerNuevaLectura(){
        if (disp == null) {     // Corregido
            System.out.println("Asigne un dispositivo antes de obtener la lectura.");
            return;
        }
        ...
        lecturasS.add(disp.leerSensorSonido());    // Corregido
    ...
    */
    ...
    public boolean evaluarApneaSuenyo() {
        ...
        if (avgP>=thresholdP && avgS >= thresholdS){ // Corregido
            resultado = true;  // Corregido
        }   
        else{
            resultado = false; // Corregido
        }
        return resultado;
    }
}
